...
def metropolis_hastings(posterior_distribution, log_likelihood, theta, x):
    #decide to either accept or reject the sample
    ...
    for i in range(1000):   
        ...
        new_log_likelihood= log_likelihood(x_new,data) 
        posterior_ratio=prior*log_likelihood/(prior*new_log_likelihood)
...
for _ in range(10):
    ...
    p, q, r  = new_estimator(theta=[p, q, r], n=n)
